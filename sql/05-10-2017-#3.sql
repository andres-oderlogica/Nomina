...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 05-10-2017 a las 20:56:28
...
INSERT INTO `contrato` (`id_contrato`, `numero_contrato`, `id_tipocontrato`, `vigencia`, `fecha_inicio`, `fecha_fin`, `valor_contrato`, `id_estado`, `id_salario`) VALUES
(1, '00001', 1, '2017', '2017-01-01', '2018-01-01', NULL, 1, NULL);
...
(27, '12345', 3, '12344', 'ANDRES', '', 'DAMIAN', '', '', '', '', '', 'andrescamila04@hotmail.com', 1),
(28, '', 1, '10301821', 'ANDRES', '', 'DAMIAN', '', '', '', '', '', 'andrescamila04@hotmail.com', 1);
...
--
ALTER TABLE `entidad`
  MODIFY `id_entidad` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
--
