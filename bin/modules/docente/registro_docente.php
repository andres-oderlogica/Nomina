...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>    
   ...
   <script src="../../../lib/bootstrap.min.js" data-semver="3.1.1" data-require="bootstrap"></script>
    <script src='js/docente.js?v=<?php echo str_replace('.', '', microtime(true)); ?>'></script>
         ...
         <!--    <div class="col-md-12">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        <form id="form_docente" action="clases/control_docente.php">
                            
                               <div class="col-md-3">
                                <input class="form-control" id="identificacion" name="identificacion" placeholder="Digita la identificacion" type="text" ><br>
                                </div>
                                <div class="col-md-9">
                                <input class="form-control" required="true" id="nombre_completo" name="nombre_completo" placeholder="Digita Nombres y Apellidos" type="text" ><br>
                                </div>
                                <div class="col-md-3">
                                <input class="form-control" id="direccion" name="direccion" placeholder="Digita la direccion" type="text" ><br>
                                 </div>
                                 <div class="col-md-3">
                                <input class="form-control" required="false" id="telefono" name="telefono" placeholder="Digita el telefono" type="text" ><br>
                               </div>
                                <div class="col-md-4">
                                <input class="form-control" required="true" id="correo" name="correo" placeholder="Digita el correo" type="email" ><br>
