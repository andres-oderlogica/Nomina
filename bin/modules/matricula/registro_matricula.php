...
<div class="container-fluid">
             <div class="col-md-12">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        <form id="form_matricula" action="clases/control_matricula.php">
                            <div class="col-md-2">
                              <label>Grado</label>
            ...
            <div class="col-md-12">
               ...
               <span class=\'glyphicon glyphicon-minus-sign\'>Crea Plantilla para alumnos seleccionados</span></button>
               </div>-->

               
                    <div class="panel-body">
                      <div class="col-md-2">
                                <button type="submit" onclick="crear()" class="btn btn-primary"><i class="glyphicon glyphicon-floppy-disk"></i> Crear Plantilla</button>
                            </div>
