...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <script src='js/grado.js?v=<?php echo str_replace('.', '', microtime(true)); ?>'></script>
  <script src='js/modal_editar_grado.js?v=<?php echo str_replace('.', '', microtime(true)); ?>'></script>
...
<div class="container-fluid">
             <div class="col-md-12">
                <div class="panel panel-primary">
                    <div class="panel-heading">Registrar Grados</div>
                    <div class="panel-body">
                        <form id="form_grado" action="clases/control_grado.php">
                            <div class="col-md-4">
                              <input class="form-control" required="true" id="descripcion" name="descripcion" placeholder="Digita el nombre del grado" type="text" ><br>
                                </div>
                                 <div class="col-md-2">
                                   <input class="form-control" required="true" id="numero" name="numero" placeholder="Digita el numero" type="text" ><br>                                                        
                                 </div>
                                 <div class="col-md-2">
...
<?php
include 'modal_editar_grado.php';
?>
<?php
