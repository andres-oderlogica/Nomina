...
$materiasOrganizadas=$boletin->buscar_materias_organizadasxgrado($cod_grado,4);

//$cortesParaVisualizar=$_GET['corte'];////varible que se va a ir cambiando(1,2,3,4) segun los cortes que se quieran visualizar 
$cortesParaVisualizar=4;////varible que se va a ir cambiando(1,2,3,4) segun los cortes que se quieran visualizar 
...
$aMostrarCorte="";	
	...
	$pdf->Render($nombreEstudiante,$aMostrar,$curso,$cortesParaVisualizar,$materiasOrganizadas);
$pdf->AddPage();
$aMostrar="";
