...
$cortesParaVisualizar=2;////varible que se va a ir cambiando(1,2,3,4) segun los cortes que se quieran visualizar 
...
$aMostrarCorte="";	
        		break;
        	case 3:
        	$finalSemestreIsin=($aMostrarCorte[o]['final']+$aMostrarCorte[1]['final'])/2;
        	$finalSemestreI=number_format($finalSemestreIsin, 0, '.', '');
        	$letraFinalSemestreI =$boletin->identificar_letra($finalSemestreI);
