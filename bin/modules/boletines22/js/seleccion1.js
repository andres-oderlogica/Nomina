...
//$('#cdosI').prop('disabled', false);
$('#cunoII').prop('disabled', false);
...
$.ajax({  url: "combo/control_combox.php",
    ...
    $("#boton").html('<a href="generador_promedios_por_grado.php?id_grado='+idg+'&corte='+corte+'" target="_blank"><button type="button" class="btn btn-primary btn-sm btn_edit" data-title="Edit" data-toggle="modal"><span class="glyphicon glyphicon-minus-sign"></span></button></a>');
