...
class Rep_Factura extends PDFReport  
{
 	...
 	public function Render($estudiante,$aMostrar,$curso,$corte,$materiasOrganizadas)
	{
		$sumatoria=0;
		$contadorMateriasValidas=0;
		...
		for ($i	=0; $i	 < count($aMostrar); $i	++) { 
			...
			{
				if($materiasOrganizadas[$i]['tipo']==2)
{
$this->Cell(5,5,"",0,0,'C');$this->Cell(45,6,"{$aMostrar[$i]['materia']}",0,0,'L');$this->Cell(11,6,"",0,0,'C');$this->Cell(11,6,"",0,0,'C');$this->Cell(9,6,"",0,0,'C');$this->Cell(9,6,"",0,0,'C');$this->Cell(11,6,"",0,0,'C');$this->Cell(11,6,"",0,0,'C');$this->Cell(9,6,"",0,0,'C');$this->Cell(11,6,"",0,0,'C');$this->Cell(9,6,"",0,0,'C');$this->Cell(9,6,"",0,0,'C');$this->Cell(11,6,"{$aMostrar[$i]['acumuladoC3']}",0,0,'C');$this->Cell(11,6,"{$aMostrar[$i]['pruebaC3']}",0,0,'C');$this->Cell(9,6,"{$aMostrar[$i]['finalC3']}",0,0,'C');$this->Cell(9,6,"{$aMostrar[$i]['letraC3']}",0,0,'C');$this->Cell(11,6,"{$aMostrar[$i]['acumuladoC4']}",0,0,'C');$this->Cell(11,6,"{$aMostrar[$i]['pruebaC4']}",0,0,'C');$this->Cell(9,6,"{$aMostrar[$i]['finalC4']}",0,0,'C');$this->Cell(11,6,"{$aMostrar[$i]['letraC4']}",0,0,'C');$this->Cell(9,6,"{$aMostrar[$i]['finalIIsemestre']}",0,0,'C');$this->Cell(9,6,"{$aMostrar[$i]['letraIIsemestre']}",0,0,'C');$this->Cell(7,6,"{$aMostrar[$i]['notaFinal']}",0,0,'C');$this->Cell(9,6,"{$aMostrar[$i]['letraFinal']}",0,0,'C');
			$this->Ln();
    	...
    	$this->Cell(5,5,"",0,0,'C');$this->Cell(45,6,"{$aMostrar[$i]['materia']}",0,0,'L');$this->Cell(11,6,"{$aMostrar[$i]['acumuladoC1']}",0,0,'C');$this->Cell(11,6,"{$aMostrar[$i]['pruebaC1']}",0,0,'C');$this->Cell(9,6,"{$aMostrar[$i]['finalC1']}",0,0,'C');$this->Cell(9,6,"{$aMostrar[$i]['letraC1']}",0,0,'C');$this->Cell(11,6,"{$aMostrar[$i]['acumuladoC2']}",0,0,'C');$this->Cell(11,6,"{$aMostrar[$i]['pruebaC2']}",0,0,'C');$this->Cell(9,6,"{$aMostrar[$i]['finalC2']}",0,0,'C');$this->Cell(11,6,"{$aMostrar[$i]['letraC2']}",0,0,'C');$this->Cell(9,6,"{$aMostrar[$i]['finalIsemestre']}",0,0,'C');$this->Cell(9,6,"{$aMostrar[$i]['letraIsemestre']}",0,0,'C');$this->Cell(11,6,"{$aMostrar[$i]['acumuladoC3']}",0,0,'C');$this->Cell(11,6,"{$aMostrar[$i]['pruebaC3']}",0,0,'C');$this->Cell(9,6,"{$aMostrar[$i]['finalC3']}",0,0,'C');$this->Cell(9,6,"{$aMostrar[$i]['letraC3']}",0,0,'C');$this->Cell(11,6,"{$aMostrar[$i]['acumuladoC4']}",0,0,'C');$this->Cell(11,6,"{$aMostrar[$i]['pruebaC4']}",0,0,'C');$this->Cell(9,6,"{$aMostrar[$i]['finalC4']}",0,0,'C');$this->Cell(11,6,"{$aMostrar[$i]['letraC4']}",0,0,'C');$this->Cell(9,6,"{$aMostrar[$i]['finalIIsemestre']}",0,0,'C');$this->Cell(9,6,"{$aMostrar[$i]['letraIIsemestre']}",0,0,'C');$this->Cell(7,6,"{$aMostrar[$i]['notaFinal']}",0,0,'C');$this->Cell(9,6,"{$aMostrar[$i]['letraFinal']}",0,0,'C');
			...
			switch ($corte) {
				...
				case 2:
					...
					break;
				case 3:
				if($materiasOrganizadas[$i]['tipo']==1)
{               
	$contadorMateriasValidas++;
				$sumatoriaC1I+=$aMostrar[$i]['finalC1'];
					$sumatoriaC2I+=$aMostrar[$i]['finalC2'];
				...
				if($materiasOrganizadas[$i]['tipo']==2)
{
    ...
    {
    	$promedioC1I=$sumatoriaC1I/$contadorMateriasValidas;
					$promedioC2I=$sumatoriaC2I/$contadorMateriasValidas;
					$promedioSI=$sumatoriaSI/$contadorMateriasValidas;
...
$materiasOrganizadas=$boletin->buscar_materias_organizadasxgrado($cod_grado,$_GET['corte']);
$estudiantesGrado=$boletin->buscar_estudiantesxgrado($cod_grado);
//var_dump($estudiantesGrado);
...
if($materiasOrganizadas[$j]['tipo']==1)
{
	$notaFinalAnosin=($finalSemestreI+$finalSemestreII)/2;
	$notaFinalAno=number_format($notaFinalAnosin, 0, '.', '');	
}
else
{
	$notaFinalAnosin=$finalSemestreII;
	$notaFinalAno=number_format($notaFinalAnosin, 0, '.', '');	
}
...
$aMostrarCorte="";	
	...
	$pdf->Render($estudiantesGrado[$i]['nombre'],$aMostrar,$curso,$cortesParaVisualizar,$materiasOrganizadas);
$pdf->AddPage();
$aMostrar="";
